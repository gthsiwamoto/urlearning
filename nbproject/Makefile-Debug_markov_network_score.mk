...
CND_DLIB_EXT=so
CND_CONF=Debug_markov_network_score
CND_DISTDIR=dist
CND_BUILDDIR=build
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/markov_network_score-debug

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/markov_network_score-debug: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/markov_network_score-debug ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/markov_network_scoring_main.o: markov_network_scoring_main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG -I${HOME}/local/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/markov_network_scoring_main.o markov_network_scoring_main.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/markov_network_score-debug
