...
CND_DLIB_EXT=so
CND_CONF=Debug_anytime_window_astar
CND_DISTDIR=dist
CND_BUILDDIR=build
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/anytime_window_astar-debug

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/anytime_window_astar-debug: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/anytime_window_astar-debug ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/anytime_window_a_star_main.o: anytime_window_a_star_main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG -I${HOME}/local/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/anytime_window_a_star_main.o anytime_window_a_star_main.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/anytime_window_astar-debug
