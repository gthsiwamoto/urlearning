...
scoring::BICScoringFunction::BICScoringFunction(datastructures::BayesianNetwork& network, datastructures::RecordFile &recordFile, LogLikelihoodCalculator *llc, scoring::Constraints *constraints) {
